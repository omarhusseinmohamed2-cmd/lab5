...
/**
 * Representerar en kant som förbinder två hörn i en graf. En kant har ett
 * starthörn, ett sluthörn, en beräknad sträcka och en visuell färgattribut för
 * rendering.
 *
...
public class Edge<T> {
	...
	/**
	 * Skapar en ny kant mellan två hörn. Avståndet beräknas automatiskt baserat på
	 * hörnens positioner, och standardfärgen sätts till grå.
	 *
