...
public class Graph<T> implements GraphInterface<T> {
    ...
    /**
     * Lägger till ett nytt hörn i grafen.
     * Om ett hörn med samma info redan finns läggs ingen ny till.
     * 
    ...
    /**
     * Lägger till en kant mellan två hörn.
     * Kanten är oriktad och lagras i båda riktningarna.
     * 
    ...
    /**
     * Hjälpmetod som räknar det totala antalet oriktade kanter i grafen.
     * Eftersom varje oriktad kant lagras som två riktade kanter,
     * divideras summan av alla kantlistors storlek med 2.
     *
