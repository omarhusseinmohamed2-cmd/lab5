...
/**
 * JUnit-tester för klassen {@link Graph}. Testar alla publika metoder med minst
 * två testfall vardera.
 *
...
public class GraphTest {
	...
	/**
	 * Skapar en ny graph och lägger till tre vertices och två kanter innan varje
	 * testmetod körs.
	 */
	@BeforeEach
	public void setUp() {
	...
	public void testRemove_tasBortKanter() {
		...
		boolean baFinns = graph.getEdges("B").stream().anyMatch(e -> e.getTo().getInfo().equals("A"));
		assertFalse(baFinns);
	}
	...
	/**
	 * Kontrollerar att kanten A-B har korrekt euklidisk distans (3-4-5-triangeln =
	 * 5.0).
	 */
	@Test
